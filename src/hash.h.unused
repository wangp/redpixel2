...
hash_table_t *construct_hash_table(hash_table_t *table,size_t size);
...
void *hash_delete(char *key,struct hash_table *table);
...
void free_hash_table(struct hash_table *table, void (*func)(void *));
