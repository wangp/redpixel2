...
#define IT_XM_FINE_VOLSLIDE     29
#define IT_XM_RETRIGGER_NOTE    30

#define IT_N_EFFECTS            31
...
struct IT_CHANNEL
{
	...
	unsigned char xm_last_E1;
	unsigned char xm_last_E2;
	unsigned char xm_last_X1;
	unsigned char xm_last_X2;
...
sigdata_t *_dumb_it_load_sigdata(DUMBFILE *f);
void _dumb_it_unload_sigdata(sigdata_t *sigdata);



sigrenderer_t *_dumb_it_start_sigrenderer(DUH *duh, sigdata_t *sigdata, int n_channels, long pos);
